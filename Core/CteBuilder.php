...
class CteBuilder
{
  ...
  public function nonrecursive(SelectBuilder ...$anchors)
  {
    $this->is_recursive = false;
    $anchor_queries = array_map(function ($anchor) {
      return $anchor->getQuery();
    }, $anchors);
    $this->expression = implode(" UNION ALL ", $anchor_queries);
    return $this;
  }
